...
# pdomain-ocr-training conventions
...
[`docs/process/lint-deviations.md`](docs/process/lint-deviations.md), which records the rule, the tool, the
...
- A suppression whose inline rationale exists but is missing from
  [`docs/process/lint-deviations.md`](docs/process/lint-deviations.md) — CT decides whether to catalogue it or
